...
/**
 * methods for verifying human pick, generate computer pick and check whether or not computer wins
 * @author Carl Shihche
 * @version 1.0
 */
public class RPSLSpock {
    ...
    /**
     *
     * @param pick - check if the check is among ROCK, PAPER, SCISSORS, LIZARD, AND SPOCK
     * @return true if the input value is among ROCK, PAPER, SCISSORS, LIZARD, AND SPOCK
     */
    ...
    /**
     *
     * @return randomly return ROCK, PAPER, SCISSORS, LIZARD, OR SPOCK
     */
    ...
    /**
     *
     * @param c_pick pick from the computer
     * @param h_pick pick from the human player
